 ...
 *   · default 永远打底:下方静态 import(skins/default/main.css),随包加载、无闪烁。
 *   · sign 的 main.css 叠加在上层(cascade 覆盖,不是二选一),切换时替换 <link>。
 *   · 内页样式定制:主题在自己的 main.css 里用 [data-sign="X"] .page-xxx {...} 触达,无需改内页组件。
 */
import '@h5/themes/skins/default/main.css';
