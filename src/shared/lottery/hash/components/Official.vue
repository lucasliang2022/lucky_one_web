...
import OfficialMethodDesc from "@shared/lottery/base/components/official/OfficialMethodDesc.vue";
import OfficialBetConfirmDialog from "@shared/lottery/base/components/official/OfficialBetConfirmDialog.vue";
import { notify } from '@shared/notify';
import {useI18n} from 'vue-i18n';
import {formatPrize} from "@shared/utils/common.ts";
import { resolveStructTitle } from "@lottery/base/utils/common";
const {t, te} = useI18n();
...
const activeComponent = computed(() => {
  ...
  return defineAsyncComponent({
    loader: () => import(`@shared/lottery/hash/components/layout/official/${methodConfig.layout.type}.vue`),
