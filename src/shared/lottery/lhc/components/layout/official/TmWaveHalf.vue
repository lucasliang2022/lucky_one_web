...
<script setup>
import { blueWave, greenWave, redWave } from '@shared/utils/common.ts';import { useOfficialLayoutLogic } from '@shared/lottery/lhc/components/layout/composables/useOfficialLayoutLogic.ts';
