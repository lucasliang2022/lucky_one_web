...
import Amount from "@lottery/components/common/Amount.vue";
import Currency from "@lottery/components/common/Currency.vue";
import CreditBetConfirmDialog from "@lottery/components/common/credit/CreditBetConfirmDialog.vue";
import CreditBetCart from "@lottery/components/common/credit/CreditBetCart.vue";
import CreditMethodDesc from "@lottery/components/common/credit/CreditMethodDesc.vue";
import DefaultGroup from "@lottery/components/ssc/layout/group/DefaultGroup.vue";
...
const handleFastBet = () => {
  ...
  const betItem = creditBetItemBuild();
