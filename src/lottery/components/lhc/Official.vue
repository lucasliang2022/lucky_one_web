    ...
    <el-tabs v-if="officialCategoryCurrent" v-model="officialCategoryCurrent" class="method-category" @tab-click="handleCategoryChange">
      ...
      >
        <ul class="method-group">
          ...
          >
            <span class="group-title" v-if="group.title">{{ t(group.title) }}:</span>
...
import Unit from "@lottery/components/common/Unit.vue";
import Times from "@lottery/components/common/Times.vue";
import Currency from "@lottery/components/common/Currency.vue";
import Loading from "@lottery/components/common/Loading.vue";
import OfficialBetCart from "@lottery/components/common/official/OfficialBetCart.vue";
import OfficialMethodDesc from "@lottery/components/common/official/OfficialMethodDesc.vue";
import OfficialBetConfirmDialog from "@lottery/components/common/official/OfficialBetConfirmDialog.vue";
...
const activeComponent = computed(() => {
  ...
  return defineAsyncComponent({
    loader: () => import(`@/lottery/components/lhc/layout/official/${methodConfig.layout.type}.vue`),
