import type { useSscStore } from '@lottery/stores/sscStore';
import type { usePk10Store } from '@lottery/stores/pk10Store';
import type { useLhcStore } from '@lottery/stores/lhcStore';
