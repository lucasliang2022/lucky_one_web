...
<script setup>
  ...
  import AutoScroll from '@web/common/tool/AutoScroll.vue';
  import NavBarNotLogin from "@web/common/nav/NavBarNotLogin.vue";
  import NavBarLogin from "@web/common/nav/NavBarLogin.vue";
